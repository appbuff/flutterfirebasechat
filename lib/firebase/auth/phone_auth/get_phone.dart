...
import 'package:flutterfirebasechat/firebase/auth/phone_auth/select_country.dart';
import 'package:flutterfirebasechat/firebase/auth/phone_auth/verify.dart';
import 'package:flutterfirebasechat/providers/countries.dart';
import 'package:flutterfirebasechat/providers/phone_auth.dart';
import 'package:flutterfirebasechat/utils/constants.dart';
...
class PhoneAuthGetPhone extends StatefulWidget {
  ...
  final String appName = "Firebase Chat";
...
class _PhoneAuthGetPhoneState extends State<PhoneAuthGetPhone> {
   ...
   *  As a default case, we are using Bangladesh as default country, index = 31
   */
  @override
  void initState() {
    super.initState();
